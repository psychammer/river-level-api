...
PRECOMPUTED_METRICS = {
    "full_model": {
        "MONTALBAN": {
            ...
            "mae":  [0.3788, 0.3266, 0.3628, 0.3372, 0.3694, 0.4053],
            "rmse": [0.6557, 0.6047, 0.6464, 0.6419, 0.6890, 0.7582],
            "nse":  [0.5125, 0.5854, 0.5262, 0.5327, 0.4618, 0.3481]
        },
        "NANGKA": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.0328, 0.0460, 0.0426, 0.0366, 0.0384, 0.0491],
            "rmse": [0.5184, 0.5195, 0.5194, 0.5190, 0.5187, 0.5202],
            "nse":  [-0.0002, -0.0045, -0.0039, -0.0024, -0.0014, -0.0069]
        },
        "SAN MATEO": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.3952, 0.3846, 0.3880, 0.4274, 0.4320, 0.5225],
            "rmse": [1.0052, 1.0107, 1.0076, 1.0744, 1.1348, 1.2623],
            "nse":  [0.9281, 0.9273, 0.9277, 0.9179, 0.9084, 0.8866]
        },
        "STO NINO": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.5620, 0.5699, 0.5546, 0.5784, 0.6064, 0.6434],
            "rmse": [1.1307, 1.1374, 1.1476, 1.1643, 1.1864, 1.2286],
            "nse":  [0.4507, 0.4443, 0.4342, 0.4177, 0.3953, 0.3516]
        },
        "TUMANA": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.3814, 0.4204, 0.4028, 0.4252, 0.4655, 0.4974],
            "rmse": [0.8063, 0.8234, 0.8764, 0.8612, 0.9037, 0.9682],
            "nse":  [0.6129, 0.5964, 0.5428, 0.5585, 0.5138, 0.4420]
        }
    },
    "ablated_model": {
        "MONTALBAN": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.3519, 0.4694, 0.3104, 0.4206, 0.3505, 0.3778],
            "rmse": [0.6134, 0.7083, 0.5658, 0.6837, 0.6560, 0.7228],
            "nse":  [0.5733, 0.4311, 0.6370, 0.4699, 0.5120, 0.4077]
        },
        "NANGKA": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.0326, 0.0286, 0.0562, 0.0277, 0.0311, 0.0263],
            "rmse": [0.5188, 0.5184, 0.5203, 0.5185, 0.5185, 0.5184],
            "nse":  [-0.0015, -0.0002, -0.0076, -0.0005, -0.0004, -0.0001]
        },
        "SAN MATEO": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.3651, 0.3670, 0.3816, 0.4197, 0.4490, 0.5123],
            "rmse": [0.8675, 0.8907, 0.9277, 1.0108, 1.0994, 1.2822],
            "nse":  [0.9464, 0.9435, 0.9388, 0.9273, 0.9140, 0.8830]
        },
        "STO NINO": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.5874, 0.5872, 0.6526, 0.5946, 0.6310, 0.6661],
            "rmse": [1.1634, 1.1713, 1.1970, 1.1672, 1.1954, 1.2484],
            "nse":  [0.4185, 0.4106, 0.3845, 0.4148, 0.3861, 0.3304]
        },
        "TUMANA": {
            "horizons": ["1h", "3h", "6h", "12h", "24h", "48h"],
            "mae":  [0.4250, 0.4245, 0.5158, 0.4728, 0.4656, 0.5713],
            "rmse": [0.8179, 0.8331, 0.8545, 0.8521, 0.8886, 0.9738],
            "nse":  [0.6017, 0.5868, 0.5653, 0.5677, 0.5300, 0.4355]
        }
    }
}
